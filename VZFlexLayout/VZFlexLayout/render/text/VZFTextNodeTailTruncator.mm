...
@implementation VZFTextNodeTailTruncator
{
    __weak VZFTextNodeTextKitContext *_context;
    NSAttributedString *_truncationAttributedString;
    NSCharacterSet *_avoidTailTruncationSet;
    CGSize _constrainedSize;
}
- (instancetype)initWithContext:(VZFTextNodeTextKitContext *)context
                                                ...
                                                textContainer:(NSTextContainer *)textContainer
{
    ...
    VZFTextNodeTextKitContext *truncationContext = [[VZFTextNodeTextKitContext alloc] initWithAttributedString:_truncationAttributedString
    ...
    [truncationContext performTextOperation:^(NSLayoutManager *truncationLayoutManager, NSTextStorage *truncationTextStorage, NSTextContainer *truncationTextContainer) {
...
- (void)_truncate
{
    [_context performTextOperation:^(NSLayoutManager *layoutManager, NSTextStorage *textStorage, NSTextContainer *textContainer) {
